...
- Party follow-up: Added Party Edge with deterministic random-looking hue choices and a visible 65%/100% brightness guide. Zero brightness was rejected as a strobe risk. Hue now reuses its HTTPS connection and drops stale queued colors so the latest BPM beat wins. Verification: 51 tests, lint, and production build passed. Commit: `6c5b494`.
